...
var COLORS_HELP: Array[String] = [Color("#d4fdeb").to_html(), Color("#d4e6fd").to_html(), Color("#fdd4e6").to_html(), Color("#fdebd4").to_html()]
## Main output color (not default though, default is none)
var COLOR_PRIMARY: String = Color("#ecf4fe").to_html()
## Auxilary output color
var COLOR_SECONDARY: String = Color("#a3b0c7").to_html()
## Extra color for type names
var COLOR_TYPE: String = Color("#95c1fb").to_html()
## Auxilary color for values
var COLOR_VALUE: String = Color("#f6d386").to_html()
## Color for the "info" level logs
var COLOR_INFO: String = Color("#a29cf5").to_html()
## Color for the "debug" level logs
var COLOR_DEBUG: String = Color("#c3e2e5").to_html()
## Color for the "warn" level logs
var COLOR_WARN: String = Color("#f89d2c").to_html()
## Color for the "error" level logs
var COLOR_ERROR: String = Color("#ff3c2c").to_html()
